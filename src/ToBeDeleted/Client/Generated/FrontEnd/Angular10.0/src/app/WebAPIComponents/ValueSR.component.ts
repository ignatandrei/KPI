...
@Component({
  selector: 'app-ValueSR-component',
  templateUrl: './ValueSR.component.html',
  styleUrls: ['./ValueSR.component.css']
})
export class ValueSRComponent implements OnInit {

  displayedColumns: string[] = ['rowIndex' , 'namesr','valuesr','dataoftarget', 'operations'];
  dataSource: MatTableDataSource<ValueSR>;
  ...
  public rows:ValueSR[]=[];
  constructor(private mainService: ValueSRService, private router: Router ) { }
  ...
  public add(): void{
    this.router.navigate(["/valuesr/add"]);
    return;
  }
