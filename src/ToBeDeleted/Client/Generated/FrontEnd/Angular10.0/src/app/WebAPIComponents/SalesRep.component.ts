...
export class SalesRepComponent implements OnInit {
  ...
  public rows:SalesRep[]=[];
  constructor(private mainService: SalesRepService, private router: Router ) { }
  ...
  public add(): void{
    this.router.navigate(["/salesrep/add"]);
    return;
  }
