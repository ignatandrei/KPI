...
namespace TestWebAPI.Controllers
{
    ...
    public class ValueSRController : ControllerBase
    {
        ...
        public ValueSRController(IRepository<ValueSR,long> repository)
        {
        ...
        // GET: api/ValueSR/5
        [HttpGet("{id}")]
        public async Task<ActionResult<ValueSR>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ValueSR>> Put(long id, ValueSR record)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ValueSR> Insert(ValueSR record)
        {
