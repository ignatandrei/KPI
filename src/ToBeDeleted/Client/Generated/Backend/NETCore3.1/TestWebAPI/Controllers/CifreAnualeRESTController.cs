...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class REST_CifreAnualeController : ControllerBase
    {
        private readonly IRepository<CifreAnuale,long> _repository;

        public REST_CifreAnualeController(IRepository<CifreAnuale,long> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<CifreAnuale>> FindAfterId(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<CifreAnuale>> Update(long id, CifreAnuale record)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<CifreAnuale> Post(CifreAnuale record)
        {
