...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class dboAssVAController : ControllerBase
    {
        private readonly  IRepository<dboAssVA,Int64> _repository;

        public dboAssVAController(IRepository<dboAssVA,Int64> repository)
        {
        ...
        // GET: api/dboAssVA/5
        [HttpGet("{id}")]
        public async Task<ActionResult<dboAssVA>> Get(Int64 id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<dboAssVA>> Put(Int64 id, dboAssVA record)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<dboAssVA> Insert(dboAssVA record)
        {
