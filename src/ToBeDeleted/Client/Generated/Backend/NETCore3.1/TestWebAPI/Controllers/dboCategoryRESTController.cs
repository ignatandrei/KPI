...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class REST_dboCategoryController : ControllerBase
    {
        private readonly IRepository<dboCategory,Int32> _repository;

        public REST_dboCategoryController(IRepository<dboCategory,Int32> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<dboCategory>> FindAfterId(Int32 id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<dboCategory>> Update(Int32 id, dboCategory record)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<dboCategory> Post(dboCategory record)
        {
