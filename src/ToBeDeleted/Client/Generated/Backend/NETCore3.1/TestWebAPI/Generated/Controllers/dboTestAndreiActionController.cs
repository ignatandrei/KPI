...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class dboTestAndreiController : ControllerBase
    {
        private readonly  IRepository<dboTestAndrei,Int32> _repository;

        public dboTestAndreiController(IRepository<dboTestAndrei,Int32> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<dboTestAndrei>> Get(Int32 id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<dboTestAndrei>> Put(Int32 id, dboTestAndrei record)
        {
            if (id != record.id)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<dboTestAndrei> Insert(dboTestAndrei record)
        {
